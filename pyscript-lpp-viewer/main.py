        ...
        if checkbutton_display.value != []:
            ...
            try:
                ...
                if len(checkbutton_display.value) == 2:
                    show_Bokeh = Bokeh_show('new.lpp', 308., 3000, 4096, 0.1, 1.43, 0.2, 1.36, 0.5, 0.5)._show('Both')
                elif len(checkbutton_display.value) == 1 and 'TOF' in checkbutton_display.value:
                    show_Bokeh = Bokeh_show('new.lpp', 308., 3000, 4096, 0.1, 1.43, 0.2, 1.36, 0.5, 0.5)._show('TOF')
                elif len(checkbutton_display.value) == 1 and 'Schottky' in checkbutton_display.value:
                    show_Bokeh = Bokeh_show('new.lpp', 308., 3000, 4096, 0.1, 1.43, 0.2, 1.36, 0.5, 0.5)._show('Schottky')
                else:
                    pass
