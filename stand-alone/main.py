    ...
    if input_file.value is not None:
        if checkbutton_display.value != []:
            ...
            if len(checkbutton_display.value) == 2:
                show_Bokeh = Bokeh_show('new.lpp', 243., 3000, 4096, 1.30, 0.2, 1.30, 0.5, 0.5)._show('Both')
            elif len(checkbutton_display.value) == 1 and 'TOF' in checkbutton_display.value:
                show_Bokeh = Bokeh_show('new.lpp', 243., 3000, 4096, 1.30, 0.2, 1.30, 0.5, 0.5)._show('TOF')
            elif len(checkbutton_display.value) == 1 and 'Schottky' in checkbutton_display.value:
                show_Bokeh = Bokeh_show('new.lpp', 243., 3000, 4096, 1.30, 0.2, 1.30, 0.5, 0.5)._show('Schottky')
            else:
                pass
...
_bokeh = pn.pane.Bokeh(visible=False)
