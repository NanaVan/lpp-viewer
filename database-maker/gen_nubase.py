...
def gen_nubase():
    ...
    keV2u = 1.07354410083e-6 # amount of u per 1 keV
            ...
            for l in nubase:
                ...
                while True:
                    ...
                    if Z == 0 and Q == 0:
                        ...
                        #print("{:}: {:}".format(element.split(" ")[0], Q))
                        _mass = mass - Q*me + (bind_eng[(bind_eng['Element']==element.split(" ")[0])&(bind_eng['Q']==0)]["Binding Energy"].values[0] - bind_eng[(bind_eng['Element']==element.split(" ")[0])&(bind_eng['Q']==Q)]["Binding Energy"].values[0])/1e3*keV2u
                        jpi = ''
                        decay_mode = ''
                    else:
                        break
